ActiveAdmin.register Course do
  ...
  form do |f|
    inputs "Course Details" do
      ...
      f.input :finish, as: :date_time_picker, input_html: {autocomplete: :off},
      picker_options: {
        dayOfWeekStart: 1,
        disabledWeekDays: [0],
        format:'d.m.Y H:i',
...
# ///////the  "input_html: {autocomplete: :off}," turn off default autocomplete made by browser for select2 inputs.
